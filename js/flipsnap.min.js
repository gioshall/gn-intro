...
(function(e, t, n) {
	...
	function v(e, t, r) {
		var o = s[t];
		o ? e[o] = r : e[t] !== n ? (s[t] = t, e[t] = r) : y(i, function(i) {
			var o = g(i) + g(t);
	...
	o.addEventListener && (t.addEventListener("gesturestart", function() {
		u = !0
		...
		return o.mspointer && (i.element.style.msTouchAction = "pan-y"), r = r || {}, i.distance = r.distance, i.maxPoint = r.maxPoint, i.disableTouch = r.disableTouch === n ? !1 : r.disableTouch, i.disable3d = r.disable3d === n ? !1 : r.disable3d, i.transitionDuration = r.transitionDuration === n ? "350ms" : r.transitionDuration + "ms", i.currentPoint = 0, i.currentX = 0, i.animation = !1, i.use3d = o.transform3d, i.disable3d === !0 && (i.use3d = !1), o.cssAnimation ? i._setStyle({
			...
			position: "relative",
			left: "0px"
		}), i.refresh(), l.forEach(function(e) {
		...
		var e = this;
		e._maxPoint = e.maxPoint === n ? function() {
			...
			return n
		}() : e.maxPoint, e.distance === n ? e._maxPoint < 0 ? e._distance = 0 : e._distance = e.element.scrollWidth / (e._maxPoint + 1) : e._distance = e.distance, e._maxX = -e._distance * e._maxPoint, e.moveToPoint()
		...
		e === n && (e = r.currentPoint), e < 0 ? r.currentPoint = 0 : e > r._maxPoint ? r.currentPoint = r._maxPoint : r.currentPoint = parseInt(e, 10), o.cssAnimation ? r._setStyle({
			transitionDuration: t
		}) : r.animation = !0, r._setX(-r.currentPoint * r._distance, t), i !== r.currentPoint && (r._triggerEvent("fsmoveend", !0, !1), r._triggerEvent("fspointmove", !0, !1))
	}, h.prototype._setX = function(e, t) {
		var n = this;
		n.currentX = e, o.cssAnimation ? n.element.style[s.transform] = n._getTranslate(e) : n.animation ? n._animate(e, t || n.transitionDuration) : n.element.style.left = e + "px"
	}, h.prototype._touchStart = function(e, n) {
		var r = this;
		if (r.disableTouch || r.scrolling || u) return;
		r.element.addEventListener(c.move[n], r, !1), t.addEventListener(c.end[n], r, !1);
		var i = e.target.tagName;
		n === "mouse" && i !== "SELECT" && i !== "INPUT" && i !== "TEXTAREA" && i !== "BUTTON" && e.preventDefault(), o.cssAnimation ? r._setStyle({
			transitionDuration: "0ms"
		}) : r.animation = !1, r.scrolling = !0, r.moveReady = !1, r.startPageX = p(e, "pageX"), r.startPageY = p(e, "pageY"), r.basePageX = r.startPageX, r.directionX = 0, r.startTime = e.timeStamp, r._triggerEvent("fstouchstart", !0, !1)
		...
		var r = p(e, "pageX"),
			...
			s, o;
		if (n.moveReady) {
			e.preventDefault(), s = r - n.basePageX, o = n.currentX + s;
		...
		var r = this;
		r.element.removeEventListener(c.move[n], r, !1), t.removeEventListener(c.end[n], r, !1);
		if (!r.scrolling) return;
		var i = -r.currentX / r._distance;
		i = r.directionX > 0 ? Math.ceil(i) : r.directionX < 0 ? Math.floor(i) : Math.round(i), i < 0 ? i = 0 : i > r._maxPoint && (i = r._maxPoint), r._touchAfter({
		...
		var n = this,
			...
			f = setInterval(function() {
				var e = new Date - i,
					t, n;
				e > u ? (clearInterval(f), n = o) : (t = a(e, u), n = t * (o - s) + s), r.style.left = n + "px"
			}, 10)
